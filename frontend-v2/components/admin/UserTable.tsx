...
const TH: React.CSSProperties = {
  padding: '13px 22px', textAlign: 'left', fontSize: 12, fontWeight: 700,
  color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.8px',
  borderBottom: '1px solid #334155', background: '#162032', whiteSpace: 'nowrap',
}
  ...
  return (
    <div>
      <div style={{
        ...
        alignItems: 'center', borderBottom: '1px solid #334155', background: '#1e293b',
      }}>
        <div style={{ flex: 1, position: 'relative' }}>
          ...
          <input
            ...
            style={{
              width: '100%', padding: '10px 14px 10px 38px', borderRadius: 9, fontSize: 14,
              boxSizing: 'border-box', border: '1px solid #334155', outline: 'none',
              background: '#0f172a', color: '#e2e8f0', transition: 'border-color 0.15s',
            }}
        ...
        <div style={{
          ...
          background: '#0f172a', color: '#475569', border: '1px solid #334155', whiteSpace: 'nowrap',
        }}>
